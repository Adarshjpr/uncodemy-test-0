...
/* ---------- Scroll sidebar to active topic ---------- */
function scrollToActiveTopic() {
  const sidebar = document.querySelector('.left-sidebar');
  const active = sidebar?.querySelector('.topic-link.active');
  if (!sidebar || !active) return;

  // Active link ko sidebar ke center me le aao
