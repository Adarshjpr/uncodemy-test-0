  ...
  const footerHTML = `  <main class="Hemank-page">
    <footer class="Hemank-footer" aria-label="UnCodemy footer">
      <section class="Hemank-footer-top">
        <div class="Hemank-footer-wrap">
          <div class="Hemank-footer-grid">
            <section class="Hemank-brand-col">
              <a class="Hemank-brand-logo" href="#" aria-label="UnCodemy home">
                <span class="Hemank-brand-mark">
                  <img src="/tutorial/components/footer-assets/Uncodemy logo-10.png" alt="Uncodemy Footer Logo">
                </span>
              </a>
              ...
              <div class="Hemank-partner-card" aria-label="Certification partners">
               <img src="/tutorial/components/images/1.jpeg" alt="Description of the image">

              </div>

              <div class="Hemank-award-card" aria-label="Awards">
               <img src="/tutorial/components/images/acheive.webp" alt="Description of the image">
              </div>

              <div class="Hemank-rating-row">
                <div class="Hemank-trust-card" aria-label="Trustpilot rating">
                 <img src="/tutorial/components/images/Trustpilot-Reviews-Services-1.webp" alt="Description of the image"> 
                </div>

                <a class="Hemank-contact-card" href="https://uncodemy.com/contact-us">
              <img src="/tutorial/components/images/CONTACT-US.webp" alt="Description of the image"> 
                </a>
              </div>
            </section>
            ...
            <div class="Hemank-links-col" aria-label="Quick links">
              <h2>Quick Links</h2>
              <ul>
            ...
            <aside class="Hemank-payment-col">
              ...
              <div class="Hemank-payment-methods" aria-label="Payment methods">
               <img src="/tutorial/components/images/payment.webp" alt="fee payment ">
              </div>

              <a class="Hemank-promo-card Hemank-fee-card" href="#">
               <img src="/tutorial/components/images/payment.jpeg" alt="fee payment ">

              </a>

              <a class="Hemank-promo-card Hemank-whatsapp-card" href="#">
                <img src="/tutorial/components/images/whatsappp-logo-png-2293-768x512.png" alt="whatsapp">
              </a>

              <a class="Hemank-promo-card Hemank-demo-card" href="#">
               <img src="/tutorial/components/images/demo.jpeg" alt="Demo classes">
              </a>

              <a class="Hemank-promo-card Hemank-placement-card" href="#">
               <img src="/tutorial/components/images/pc5.jpg" alt="Placement ">
              </a>
            </aside>
          </div>
        </div>
      ...
      <nav class="Hemank-mobile-cta" aria-label="Mobile footer actions">
        <a class="Hemank-mobile-whatsapp" href="https://api.whatsapp.com/send?phone=918800023723">WhatsApp</a>
